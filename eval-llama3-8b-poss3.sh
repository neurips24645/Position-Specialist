DraftPath=neurips24645/llama3-8b-instruct-poss3
...
do
	...
	do
		for DEPTH in 5 6 7
		do
			CUDA_VISIBLE_DEVICES=0 python -m evaluation.gen_poss_answer_llama3chat \
				--ea-model-path ${DraftPath} \
				--base-model-path ${TargetPath} \
				--temperature 0 \
				--model-id llama3-8b-poss3-depth${DEPTH}-tt60-iter${iter} \
...
do
    ...
    do
		for iter in 1 2 3
		do
            FileName="llama3-8b-poss3-depth${DEPTH}-tt60-iter${iter}-temperature-0.0.jsonl"
